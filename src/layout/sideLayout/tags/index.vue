...
export default {
  ...
  methods: {
    ...
    setTags(route) {
      ...
      // console.log("type", this.$route.query.orderType);
      ...
      switch (this.$route.query.orderType) {
        case 1:
          this.$route.meta.title = "新增会员概况";
          break;
        case 2:
          this.$route.meta.title = "活跃会员概况";
          break;
        case 3:
          this.$route.meta.title = "沉默会员概况";
          break;
        case 4:
          this.$route.meta.title = "流失会员概况";
          break;
        case 4:
          this.$route.meta.title = "累计留存概况";
          break;
      }
      if (!isExist) {
        this.tagsList.push({
