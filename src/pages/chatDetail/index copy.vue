          ...
          if (this.form.keyword != "" && this.form.type == 4) {
            ...
            for(let i=0;i<this.chatRecordData.length;i++){
              if(this.chatRecordData[i].msgContent.indexOf(this.form.keyword)!=-1){
               ...
               let replaceString =
               `<i style="color:red;font-style:normal;">${this.form.keyword}</i>`
              
                if(this.chatRecordData[i].msgContent.match(reg)){
                  console.log(111,this.chatRecordData[i].msgContent)
                   console.log(this.chatRecordData[i].msgContent.replace(this.form.keyword,replaceString))
