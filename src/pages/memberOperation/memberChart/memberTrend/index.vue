      ...
      <el-col>
        <el-card shadow="hover" style>
          <div slot="header" class=" heard-item">
            <p class="title">{{title}}会员运营趋势-新增会员</p>
          ...
          <div id="addChart" style="width: 100%;height:400px;" v-loading="loading"></div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      // console.log(this.$refs.queryConditions.changeParams())
      // this.$root.Bus.$emit("timeParams", this.params);
      this.getAddLineReq(this.params);
    ...
    onChartsInit(e) {
      ...
      var myChart = echarts.init(document.getElementById("addChart"));
      // console.log('看看是我吗',myChart)
      var trigger;
      if (this.figureline) {
        trigger = "item";
      } else {
